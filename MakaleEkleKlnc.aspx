<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanici.Master" AutoEventWireup="true" CodeBehind="MakaleEkleKlnc.aspx.cs" Inherits="Sporizma.MakaleEkleKlnc" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="YoneticiPanel/css/formdesign.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server"> 
    <div class="klncformtasiyici">
        <div class="kekleyazi">
            Antrenman Ekle
        </div>
